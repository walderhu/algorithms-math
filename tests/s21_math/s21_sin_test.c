...
START_TEST(sin_test_1) {
    double x = 1;
    ck_assert_ldouble_eq_tol(s21_sin(x), sinl(x), S21_EPSILON);
}
END_TEST
...
Suite *s21_sin_suite() {
    Suite *s = suite_create("\033[42m-=s21_exp_sin=-\033[0m");
    TCase *t = tcase_create("s21_sin_test");
    tcase_set_timeout(t, 1000);
    tcase_add_test(t, sin_test_1);
    tcase_add_test(t, sin_test_2);
    tcase_add_test(t, sin_test_3);
    tcase_add_test(t, sin_test_4);
    tcase_add_test(t, sin_test_5);
    tcase_add_test(t, sin_test_6);
    tcase_add_test(t, sin_test_7);
    tcase_add_test(t, sin_test_8);
    suite_add_tcase(s, t);
    return s;
}